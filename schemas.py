...
class Observation(BaseModel):
    ...
    agent_score_deductions: float = Field(0.0, description="Penalty points tracking loop costs (-0.1) or human escalation (-0.25).")
...
class Reward(BaseModel):
    score: float = Field(0.0, description="The current graded score of the task. Range 0.0 to 1.0.")
